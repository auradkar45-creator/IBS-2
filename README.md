...
- Dataset models mutation burden at nucleotide level.
- Balanced class distribution maintained (3000 healthy / 3000 diseased).
- Sequence integrity validated via redundancy and alignment analysis.
- No structural modifications were introduced.
